  ...
  return (
    <div className={cx(className, 'flexRow center')} css={classes.toolbar}>
      ...
      {showTextEditorToolbarMenu(toolbar, 'heading') && (
        <Heading editor={editor} headingLabels={labels?.headings} split />
      )}
      ...
      {menus.map((menu, index) => {
        ...
        const labelProps = menu.id
          ? { htmlFor: menu.id, css: { cursor: 'pointer' } }
          : {};
        return (
